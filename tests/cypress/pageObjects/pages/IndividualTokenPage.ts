...
const RECEIVING_ICON = '[data-cy=stream-incoming-icon]';
const SENDING_ICON = '[data-cy=stream-outgoing-icon]';
...
const INCOMING_ARROW = '[data-cy=transfer-incoming-icon]';
const OUTGOING_ARROW = '[data-cy=transfer-outgoing-icon]';
