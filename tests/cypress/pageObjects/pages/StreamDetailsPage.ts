...
export class StreamDetailsPage extends BasePage {
    ...
    static validateEndedStreamData() {
        cy.fixture("streamData").then(streamData => {
            ...
            this.hasText(SENDER_AND_RECEIVER,BasePage.shortenHex(endedStream.sender),0)
            this.hasText(SENDER_AND_RECEIVER,BasePage.shortenHex(endedStream.receiver),-1)
    ...
    static validateOngoingFlowData() {
        cy.fixture("streamData").then(streamData => {
            ...
            this.hasText(SENDER_AND_RECEIVER,BasePage.shortenHex(ongoingStream.sender),0)
            this.hasText(SENDER_AND_RECEIVER,BasePage.shortenHex(ongoingStream.receiver),-1)
    ...
    static validateReceiverSenderExplorerLinks() {
        cy.fixture("streamData").then(streamData => {
            const endedStream = streamData["staticBalanceAccount"]["polygon"][0]
            this.hasAttributeWithValue(`${SENDER_RECEIVER_EXPLORER_BUTTONS} a`,"href",`${polygonExplorerLink}/address/${endedStream.sender}`,0)
            this.hasAttributeWithValue(`${SENDER_RECEIVER_EXPLORER_BUTTONS} a`,"target","_blank",0)
            this.hasAttributeWithValue(`${SENDER_RECEIVER_EXPLORER_BUTTONS} a`,"href",`${polygonExplorerLink}/address/${endedStream.receiver}`,-1)
            this.hasAttributeWithValue(`${SENDER_RECEIVER_EXPLORER_BUTTONS} a`,"target","_blank",-1)
        })
    }
    ...
    static clickReceiverSenderCopyButtonsAndValidateTooltip() {
        cy.fixture("streamData").then(streamData => {
            ...
            this.hasAttributeWithValue(SENDER_RECEIVER_COPY_BUTTONS,"test-data",endedStream.sender,0)
            this.hasAttributeWithValue(SENDER_RECEIVER_COPY_BUTTONS,"test-data",endedStream.receiver,-1)
        })
    }
    ...
    static validateTxHashHyperlink() {
        cy.fixture("streamData").then(streamData => {
            const endedStream = streamData["staticBalanceAccount"]["polygon"][0]
            this.hasAttributeWithValue(TX_HASH_EXPLORER_BUTTON,"href",`${polygonExplorerLink}/tx/${endedStream.txHash}`,0)
            this.hasAttributeWithValue(TX_HASH_EXPLORER_BUTTON,"target","_blank",0)
        })
    }
    ...
    static validateStreamCopyButtonTooltipsAndLink() {
        cy.fixture("streamData").then(streamData => {
            ...
            this.doesNotExist(VISIBLE_TOOLTIP)
            this.hasAttributeWithValue(ALL_COPY_BUTTONS,"test-data",`https://app.superfluid.finance${endedStream.v2Link}`,-1)
        })
    }
    ...
    static validateCloseEndedStreamData() {
        cy.fixture("streamData").then(streamData => {
            ...
            this.hasText(SENDER_AND_RECEIVER,BasePage.shortenHex(closeEndedStream.sender),0)
            this.hasText(SENDER_AND_RECEIVER,BasePage.shortenHex(closeEndedStream.receiver),-1)
