Feature: Approvals page test cases

  Scenario: Wallet Not connected screen in approvals page
    Given "Approvals page" is open without connecting a wallet
    Then Approvals page wallet not connected screen is visible

  @skip
  Scenario: No permissions set screen showing up
    Given "Approvals Page" is open with "alice" connected on "polygon"
    Then Approvals page No Access Data screen screen is visible

  Scenario: Open and close approvals Modal in approvals page
    Given "Approvals Page" is open with "alice" connected on "polygon"
