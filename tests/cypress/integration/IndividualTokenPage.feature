Feature: Token page test cases
    ...
    Scenario: Transfers table in token page
        ...
        And Only the "Sent" transfers are shown for "staticBalanceAccount" on "opsepolia" for "fUSDC"
        And User switches to the "received" tab in the transfer table
        And Only the "Received" transfers are shown for "staticBalanceAccount" on "opsepolia" for "fUSDC"
