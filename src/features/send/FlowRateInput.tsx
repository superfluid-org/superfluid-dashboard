...
// TODO(KK): memoize
export const calculateTotalAmountWei = ({amountWei, unitOfTime}: FlowRate) =>
    BigNumber.from(amountWei).div(unitOfTime);
        ...
        <>
            ...
            >
                {unitOfTimeList.map((unitOfTime) => (
                    <MenuItem value={unitOfTime}>{timeUnitWordMap[unitOfTime]}</MenuItem>
                ))}
            </Select>
        </>
    );
