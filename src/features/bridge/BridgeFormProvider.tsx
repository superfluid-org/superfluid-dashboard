...
const BridgeFormProvider: FC = ({ children }) => {
  ...
  const formSchema = useMemo(
    () =>
      object().test(async (values, context) => {
        const primarySchema: ObjectSchema<ValidBridgingForm> = object({
          data: object({
            tokenPair: object({
        ...
        const validForm = values as ValidBridgingForm;
...
export default BridgeFormProvider;
