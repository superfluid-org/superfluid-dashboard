export const vestingSchedulerV3Abi = [
  ...
  },
  {
    ...
    name: "accountings",
    outputs: [
      { internalType: "uint256", name: "alreadyVestedAmount", type: "uint256" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint32", name: "claimValidityDate", type: "uint32" },
    ],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "int96", name: "flowRate", type: "int96" },
          { internalType: "uint256", name: "cliffAmount", type: "uint256" },
          { internalType: "uint96", name: "remainderAmount", type: "uint96" },
          { internalType: "uint32", name: "claimValidityDate", type: "uint32" },
        ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "receiver", type: "address" },
      { internalType: "uint256", name: "newTotalAmount", type: "uint256" },
      { internalType: "bytes", name: "ctx", type: "bytes" },
    ],
